...
export type Event = { id: string; type: EventType; event_date: string; status: 'draft'|'locked'|'generated' }
export type EventReward = { reward_type: RewardType; quantity: number; per_member_cap?: number | null }
export type Allocation = { event_id: string; member_id: string | null; item_type: RewardType; slot_index: number; page_number: number; row_number: number }
